      ...
      <div className="section-container">
        ...
        <div className="relative">
          ...
          {resumeData.experience.map((company, companyIndex) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-2.5 md:left-6.5 top-2 w-4 h-4 rounded-full bg-primary ring-4 ring-background shadow-lg" />
                ...
                {company.roles.map((role, roleIndex) => {
                  ...
                  return (
                    <motion.div
                      key={roleId}
                      layout
                      className="card-interactive bg-card rounded-2xl border border-border overflow-hidden"
                    >
                      <button
