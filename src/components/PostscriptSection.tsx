      ...
      <div className="section-container">
        ...
        >
          <p className="text-xl sm:text-2xl font-body text-foreground leading-relaxed text-justify">
            ...
            The colours and the borders on this page come out of my love of Indian folk art like Madhubani, Pattachitra, Pichwai and more. It is a practice I keep up badly and love anyway, and it is the reason this site looks like this rather than like a template.
          </p>
        </motion.div>
      </div>
    </section>
