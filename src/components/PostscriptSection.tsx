      ...
      <div className="section-container">
        ...
        >
          <p className="text-xl sm:text-2xl font-body text-foreground leading-relaxed text-justify">
            ...
            The colours and borders on this page come from my love of Indian folk art: Madhubani, Pattachitra, Pichwai and more. That love is the reason this site looks like this rather than like a template.
          </p>
        </motion.div>
      </div>
    </section>
