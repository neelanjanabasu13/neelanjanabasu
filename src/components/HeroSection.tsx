    ...
    <section id="hero" className="relative min-h-screen hero-gradient overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-1/2 -right-1/4 w-[800px] h-[800px] rounded-full bg-teal-light/10 blur-3xl"
        />
        <motion.div
          animate={{ rotate: -360 }}
          transition={{ duration: 70, repeat: Infinity, ease: "linear" }}
          className="absolute -bottom-1/2 -left-1/4 w-[600px] h-[600px] rounded-full bg-coral-warm/10 blur-3xl"
        />
      </div>
      ...
      <div className="relative z-10 section-container flex flex-col justify-center min-h-screen py-20">
        <div className="max-w-4xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/10 backdrop-blur-sm text-primary-foreground/90 text-sm font-medium mb-8"
          >
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl lg:text-7xl font-display font-bold text-primary-foreground mb-6 leading-tight"
          >
          ...
          >
            {resumeData.highlights.map((stat, index) => (
              <motion.div
                ...
                className="text-center p-4 rounded-2xl bg-primary-foreground/5 backdrop-blur-sm"
              >
