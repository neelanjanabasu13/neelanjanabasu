...
import addToCartAsset from "@/assets/amazon-add-to-cart.jpg.asset.json";
          ...
          {portfolioItems.map((item, index) => (
            ...
            >
              <div className="aspect-video flex items-center justify-center relative overflow-hidden bg-secondary">
                {item.image ? (
                  <img src={item.image} alt={item.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" style={{ objectPosition: (item as any).objectPosition || '0 -80px' }} />
                ) : (
