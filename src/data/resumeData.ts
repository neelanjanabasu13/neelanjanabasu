          ...
          achievements: [
            {
              metric: "$2B",
              description:
                "incremental revenue by launching Add to Cart on Search — scoped ruthlessly, shipped iteratively, scaled to 93% worldwide impressions across 1000+ product types",
            },
            {
              metric: "$250M",
              description:
                "revenue impact by identifying and solving a critical customer pain point around quantity information — drove clarity across 5M+ products through data-driven discovery",
            },
            {
              metric: "100M+",
              description:
            ...
            },
            {
              metric: "$140M",
              description:
                "revenue from EU market expansion — localised five features across markets, navigating compliance and regional stakeholder requirements",
            },
          ],
        },
        {
          ...
          achievements: [
            ...
            },
            {
              metric: "$25M",
              description:
                "revenue driven by automated range-review tool — identified operational bottleneck, scoped an AI-assisted solution, and shipped to production",
            },
          ],
        },
        {
          ...
          achievements: [
            ...
            },
            {
              metric: "90%",
              description:
                "overhead cost reduction through a catalogue data enrichment engine — automated a manual process to enable scale",
            },
            {
              metric: "5%",
              description:
      ...
      roles: [
        {
          ...
          description:
            "India's first ride-hailing service. Built a 0-to-1 product vertical from scratch, taking it from concept to launch across 13 cities — full ownership of strategy, roadmap, and cross-functional delivery.",
          achievements: [
            {
              metric: "$5M",
              description:
                "annual revenue from a new product vertical, expanded across 13 Indian cities — demonstrated end-to-end product ownership and rapid market expansion",
            },
          ],
        },
      ],
