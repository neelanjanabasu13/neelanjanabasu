...
export const LotusLeaves = ({ size = 32, ...rest }: Props) => (
  <svg {...base(size)} {...rest}>
    {/* leaf left */}
    <path d="M6 26 C 7 20, 13 17, 17 20 C 15 25, 10 28, 6 26 Z" fill="#3F6B2F" stroke={STROKE} strokeWidth={SW} />
    <path d="M8 24 C 11 22, 14 21, 16 21" stroke={STROKE} strokeWidth={SW} />
    {/* leaf right */}
    <path d="M34 27 C 33 21, 28 17, 24 20 C 26 26, 30 29, 34 27 Z" fill="#5FA83C" stroke={STROKE} strokeWidth={SW} />
    <path d="M32 25 C 29 23, 26 22, 24 22" stroke={STROKE} strokeWidth={SW} />
    {/* outer petals */}
    <path d="M20 8 C 14 12, 12 20, 15 25 C 19 22, 21 15, 20 8 Z" fill="#E38FA8" stroke={STROKE} strokeWidth={SW} />
    <path d="M20 8 C 26 12, 28 20, 25 25 C 21 22, 19 15, 20 8 Z" fill="#E38FA8" stroke={STROKE} strokeWidth={SW} />
    {/* inner petals */}
    <path d="M20 12 C 16 16, 16 22, 20 25 C 24 22, 24 16, 20 12 Z" fill="#C1272D" stroke={STROKE} strokeWidth={SW} />
    <path d="M17 20 L 20 22 L 23 20" stroke={STROKE} strokeWidth={SW} />
  </svg>
);
